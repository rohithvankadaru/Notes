  ...
  return (
    <>
      <NavBar
        ...
        <br />
      <div className='home'>
        <div style={{ cursor: 'pointer', position: 'fixed', right: '50px', bottom: '50px'}} className='add-note d-flex flex-col align-center justify-center'><img src='https://cdn3.iconfinder.com/data/icons/documents-and-files-2/512/Add_Notes-512.png' style={{ width: '80px' }} onClick={showModal} /><span style={{ fontSize: '12px' }}>Add Note</span></div>
